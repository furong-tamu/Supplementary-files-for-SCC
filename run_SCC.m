% This script is used for the production of Figures 2-6 and Tables 1-3 in the manuscript
% as well as Figures 5,6 and Table 1 in the supplementary file.
...
%        'SF5' or 'ST1' for the supplementary materials
OBJ='F6';
%-----------------------------------------------------
...
% Produce Figure 5 in the supplementary materials
if strcmp(OBJ,'SF5')==1
    % load data
...
% Produce  Figure 6 and Table 1 in the supplementary materials
if strcmp(OBJ,'SF6')==1||strcmp(OBJ,'ST1')==1
